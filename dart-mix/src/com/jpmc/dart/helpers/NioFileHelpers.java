...
public class NioFileHelpers {
	public static File getTempFileWithRetry(ManagedTempFiles files, String prefix,String suffix,File makeInDirectory) throws Exception{
		File ret=null;
	...
	public static void writeFileWithRetry(File data, InputStream input, long count) throws Exception{
		Exception throwMe=null;
		for (int i = 0 ; i < 10 ;i++){
